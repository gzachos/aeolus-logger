...
append_body () {
	...
	echo -e "\t\t<h3><u>RSS Feed</u></h3>\n\t\t<p>\n\t\t\tIn the following URL, you can find the RSS v2.0 feed of Aeolus Logger which is updated every time temperature exceeds 26 or equals -30 degrees Celsius (Minus 30 degrees is a value that indicates a specific kind of error). The feed will be updated at most once per hour. <a href=\"http://aeolus.cs.uoi.gr/feed/\">[Aeolus Logger RSS feed]</a>\n\t\t</p>\n\t\t<br>" >> ${TMP_FILE}
	((EC += $?))
